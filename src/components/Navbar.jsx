...
const Navbar = () => {
  ...
  return (
   <>
    <div className=" navbar z-[999] flex justify-between items-center p-4 text-[#565656] ">
      {/* Apply text-white to make the SVG white */}
      <svg
        className="text-[#212121] w-20 h-8 ml-7 mt-1" // Ensure text-white is applied
        width="72"
        height="30"
        viewBox="0 0 72 30"
        fill="none"
      ...
      <div className="nav-items pl-88 flex align-center justify-between gap-7 mt-1 font-NeueMontreal font-semibold">
         {["Services", "Our Work", "About Us", "Insights"].map((item) => (
           <motion.a
            onMouseEnter={() => setHovered(true)}
            onMouseLeave={() => setHovered(false)}
            href="#"
            className="text-[#565656] font-NeueMontreal"
           >
             {item}
           </motion.a>
         ))}
      ...
      <div className="contact mr-7 font-NeueMontreal font-semibold">
        <h4>Contact Us</h4>
      </div>
    </div>
    </>
