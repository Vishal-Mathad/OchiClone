...
const Footer = () => {
  return (
    <div className='w-full flex items-start  min-h-screen border-t-1 border-zinc-600  bg-[#F1F1F1] m-0 p-0 box-border'>
      <div className='w-1/2 flex flex-col items-start gap-106'>
          <h1  style={{ letterSpacing: '-0.07em' }} className='text-[112px] m-10 mt-20 font-TestFounderGroteskX-CndSmb uppercase font-bold  leading-[0.8em] '>
              Eye- <br /> opening
          </h1>
          <svg className='ml-13' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='w-1/2 flex flex-col items-start gap-10'>
        <div style={{ letterSpacing: '-0.07em' }} className='text-[96px] uppercase font-TestFounderGroteskX-CndSmb uppercase font-bold mt-10 '>Presentations</div>
        <div className='text-[16px] ml-2 flex flex-col gap-5 font-BebasNeue font-regular text-[#212121]'>
          <h4>S:</h4>
          <div>
            <h4><u>Instagram</u></h4>
            <h4><u>Behance</u></h4>
        ...
        <div className='flex items-start gap-100 text-[16px] font-BebasNeue font-regular text-[#212121]'>
          <div className='flex flex-col gap-5'>
            <h4>L:</h4>
            <div className='flex flex-col gap-8'>
              <div>
                <h4><u>202-1965 W 4th Ave</u></h4>
                <h4><u>Vancouver, Canada</u></h4>
              </div>
              <div>
                <h4><u>30 Chukarina St</u></h4>
                <h4><u>Lviv, Ukraine</u></h4>
              </div>
            </div>
          </div>
          <div className='flex flex-col gap-5'>
        ...
        <div className='text-[16px] font-BebasNeue font-regular text-[#212121] flex flex-col gap-5'>
          <h4>
            E:
          </h4>
          <a href="#"><u>hello@ochi.design</u></a>
        </div>
        <div className='flex gap-70 text-[#BDBDBD]'>
          <div className='flex'>
            <h4>©</h4>
            <h4> ochi design 2025. Legal Terms</h4>
          </div>
          <div>
            <h4>Clone by Vishal Mathad</h4>
          </div>
        </div>
      </div>
    </div>
